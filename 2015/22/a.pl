...
if (TEST) {
  ...
  assert("boss HP", 13, $game->{boss}->{HP});
  assert("player HP", 10, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 77, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("boss HP", 10, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 77, $game->{player}->{MANA});
  play_turn($game, 'player', 'Magic Missile');
  assert("boss HP", 3, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 24, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("winner", "player", $game->{winner});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 24, $game->{player}->{MANA});
  ...
  assert("boss HP", 14, $game->{boss}->{HP});
  assert("player HP", 10, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 21, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("boss HP", 14, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 122, $game->{player}->{MANA});

  play_turn($game, 'player', 'Shield');
  assert("boss HP", 14, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 7, $game->{player}->{Armor});
  assert("player MANA", 110, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("boss HP", 14, $game->{boss}->{HP});
  assert("player HP", 1, $game->{player}->{HP});
  assert("player Armor", 7, $game->{player}->{Armor});
  assert("player MANA", 211, $game->{player}->{MANA});

  play_turn($game, 'player', 'Drain');
  assert("boss HP", 12, $game->{boss}->{HP});
  assert("player HP", 3, $game->{player}->{HP});
  assert("player Armor", 7, $game->{player}->{Armor});
  assert("player MANA", 239, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("boss HP", 12, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 7, $game->{player}->{Armor});
  assert("player MANA", 340, $game->{player}->{MANA});

  play_turn($game, 'player', 'Poison');
  assert("boss HP", 12, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 7, $game->{player}->{Armor});
  assert("player MANA", 167, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("boss HP", 9, $game->{boss}->{HP});
  assert("player HP", 1, $game->{player}->{HP});
  assert("player Armor", 7, $game->{player}->{Armor});
  assert("player MANA", 167, $game->{player}->{MANA});

  play_turn($game, 'player', 'Magic Missile');
  assert("boss HP", 2, $game->{boss}->{HP});
  assert("player HP", 1, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 114, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("winner", "player", $game->{winner});
  assert("player HP", 1, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  ...
  $game->{boss}->{HP} = 20;
  play_turn($game, 'player', 'Poison');
  assert("boss HP", 20, $game->{boss}->{HP});
  assert("player HP", 10, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 77, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("boss HP", 17, $game->{boss}->{HP});
  assert("player HP", 2, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 77, $game->{player}->{MANA});
  play_turn($game, 'player', 'Magic Missile');
  ...
  assert("player MANA", 24, $game->{player}->{MANA});
  play_turn($game, 'boss');
  assert("winner", "boss", $game->{winner});
  assert("player HP", -6, $game->{player}->{HP});
  assert("player Armor", 0, $game->{player}->{Armor});
  assert("player MANA", 24, $game->{player}->{MANA});
  # $game = dclone($i);
  # play_turn($game, 'player', 'Poison');
