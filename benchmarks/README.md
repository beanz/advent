...
Day 09 | 81.6ms | 63.3ms | 14.2ms / 74.6 KB | 13.8ms | 4.55ms / None
Day 10 | 41.2ms | 15.5ms | 30.3ms / 11.3 MB | 29.7ms | 1.91ms / None
Day 11 | 24ms | 18.1ms | 7.38ms / 888 KB | 5.01ms | 1.39ms / None
Day 12 | 487ms | 2.53s | 15.8ms / 736 B | 435ms | 7.83ms / None
Day 13 | 177ms | 170ms | 35.8ms / 2.9 MB | 30.6ms | 13.2µs / None
Day 14 | 7.86ms | 13.4ms | 11.6ms / 281 KB | 7.99ms | 4.33ms / 409 KB
Day 15 | 46.4ms | 33.7ms | 12.6ms / 32.5 MB | 30.2ms | 25.4µs / None
Day 16 | 265ms | 541ms | **🔴 604ms** / 1.1 MB | 689ms | **🔴 268ms** / 524 KB
Day 17 | 26.6ms | 25.7ms | 5.52ms / 304 KB | 4.1ms | 10.7µs / None
Day 18 | **🔴 2.43s** | **🔴 19.1s** | **🔴 814ms** / **🔴 405 MB** | **🔴 1m8s** | **🔴 392ms** / **🔴 94.4 MB**
Day 19 | 583ms | 408ms | 105ms / 66.6 MB | 115ms | 13.7µs / None
Day 20 | 557ms | 483ms | 59.9ms / 64.4 MB | 867ms | 11.6ms / None
Day 21 | 125ms | 375ms | 23.8ms / 124 KB | 20.8ms | 12.8µs / None
Day 22 | 4.37µs | 146µs | 397µs / 111 KB | 48.1µs | 15µs / None
Day 23 | 74.6ms | 64.4ms | 14.9ms / 4.7 MB | 15.7ms | 25µs / None
Day 24 | 50.4ms | 79.1ms | 331ms / **🔴 196 MB** | 51.7ms | 10.7ms / None
Day 25 | **🔴 1.46s** | 1.93s | 212ms / 43.8 MB | 202ms | 30.5µs / None
*Total* | *6.49s* | *25.9s* | *2.36s / 873 MB* | *1m10.8s* | *707ms / 95.6 MB*
...
Day 03 | 195ms / 64.2 MB | **🔴 8.68ms** / None
...
*Total* | *10.7s / 2.3 GB* | *10.8ms / None*
...
## Golang
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 29.1µs / None | 125µs / 101 KB | 40µs / 2.3 KB | 1.7ms / None | 6.66µs / 3.4 KB | 21.5ms / 14.1 MB | 28.3µs / 81.9 KB | 17.4µs / None
...
*Total* | *11.4s / 2.2 GB* | *20.4s / 314 MB* | *3.5s / 430 MB* | *10.7s / 2.3 GB* | *2.36s / 873 MB* | *3.6s / 757 MB* | *1.67s / 234 MB* | *757ms / 209 MB*
...
Day 03 | 926µs / 279 KB | 501µs / 183 KB | 21.6µs / 14.3 KB | **🔴 8.68ms** / None | 86.9µs / None | 5.77µs / None | 41.8µs / 2.0 KB | 38.1µs / None
...
Day 09 | 9.59ms / 651 KB | 289µs / 361 KB | 101µs / 89.3 KB | - | 4.55ms / None | 239µs / None | 214µs / 19.5 KB | 419µs / None
Day 10 | 1.17s / **🔴 312 MB** | 278µs / 90.7 KB | 210µs / 1.1 KB | - | 1.91ms / None | 1.02µs / None | 64.2µs / 2.3 KB | 1.19µs / None
Day 11 | 98ms / 15.0 MB | 2.25s / **🔴 785 MB** | 165µs / None | - | 1.39ms / None | 24.5ms / 2.0 MB | 243µs / 346 B | 5.72ms / None
Day 12 | 546µs / 357 KB | 3.97µs / 5.8 KB | 1.62ms / 1.1 MB | - | 7.83ms / None | 7.82µs / None | 8.63ms / 1.2 KB | 315µs / None
Day 13 | 181ms / 7.2 MB | 193µs / 101 KB | **🔴 737ms** / 2.4 KB | - | 13.2µs / None | 1.34µs / 256 B | 515µs / 265 KB | 454µs / 391 KB
Day 14 | 907µs / 425 B | **🔴 8.25s** / 76.0 B | 40.5ms / **🔴 39.3 MB** | - | 4.33ms / 409 KB | 6.87ms / 4.5 MB | 34µs / 1.8 KB | 6.56ms / None
Day 15 | 77.4ms / 44.1 MB | 11.2ms / 432 B | **🔴 1.61s** / 32.0 B | - | 25.4µs / None | **🔴 650ms** / **🔴 49.4 MB** | 119ms / **🔴 133 MB** | 2.22µs / None
Day 16 | 525µs / 250 KB | 161ms / 67.1 MB | 34.1ms / 10.6 MB | - | **🔴 268ms** / 524 KB | 456µs / 141 KB | 13.9µs / 4.8 KB | **🔴 378ms** / **🔴 35.7 MB**
Day 17 | 65.1ms / 84.1 MB | 44.3ms / 35.4 MB | 484ms / 16.1 KB | - | 10.7µs / None | 71.4ms / **🔴 21.7 MB** | 1.92ms / None | 347µs / None
Day 18 | 27ms / 56.4 KB | 533ms / 63.8 MB | 939µs / 4.0 KB | - | **🔴 392ms** / **🔴 94.4 MB** | 252µs / None | 47.8ms / 15.5 MB | 222µs / None
Day 19 | 1.62ms / 546 KB | 67ns / None | - | - | 13.7µs / None | 55.3ms / 14.0 MB | 20.7ms / 2.0 MB | 63.7ms / **🔴 67.3 MB**
Day 20 | **🔴 2.76s** / 126 MB | 177µs / 76.3 KB | - | - | 11.6ms / None | 385µs / 90.9 KB | 38.3ms / 2.0 MB | 38.3ms / None
Day 21 | 66.3µs / 16.9 KB | 55ms / 4.4 MB | - | - | 12.8µs / None | 396µs / 121 KB | 1.7µs / 8.0 B | 463µs / 270 KB
Day 22 | 749ms / **🔴 234 MB** | 23.9ms / 194 KB | - | - | 15µs / None | 60.8ms / 15.1 MB | 17ms / 2.3 MB | 658µs / None
Day 23 | 9.35µs / 1.2 KB | 8.11µs / 21.1 KB | - | - | 25µs / None | **🔴 504ms** / None | **🔴 1.56s** / **🔴 165 MB** | 87.6ms / None
Day 24 | 14.1ms / 10.0 MB | 7.42ms / 3.8 MB | - | - | 10.7ms / None | 119ms / None | 15µs / 576 B | **🔴 148ms** / 19.2 MB
Day 25 | 525ns / 32.0 B | 11.8ms / 7.3 KB | - | - | 30.5µs / None | 43.6ms / None | 39.5ms / 19.4 KB | 7.29µs / None
*Total* | *7.33s / 994 MB* | *20.6s / 1.7 GB* | *2.97s / 55.6 MB* | *10.8ms / None* | *707ms / 95.6 MB* | *1.54s / 108 MB* | *1.85s / 321 MB* | *731ms / 123 MB*
