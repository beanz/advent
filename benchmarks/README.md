...
Day 04 | **🔴 1.92s** | 2.84ms | 3.38ms | **🔴 85.3µs** | 106µs
Day 05 | 396µs | 8.17s | 55.1ms | - | 1.06ms
Day 06 | 54.3ms | 1.28ms | 2.15ms | - | 1.79µs
Day 07 | 356µs | 4.45ms | 1.03ms | - | 35.9µs
Day 08 | 71µs | 21.4µs | 348µs | - | 45.3µs
Day 09 | 8.7ms | 275µs | 99.3µs | - | 194µs
...
*Total* | *6.64s* | *1m5.9s* | *2.94s* | *401µs* | *1.77s*
...
Day 04 | 1.29ms | 602µs | 15.8ms | **🔴 85.3µs** | 3.01ms
...
*Total* | *16.8s* | *3.82s* | *2.9s* | *401µs* | *8.99s*
