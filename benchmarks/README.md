...
Day 11 | 1.35ms / None | 1.06ms / None | 987µs
...
Day 17 | 19.4µs / 24.0 B | 216µs / None | 75.4µs
...
## 2015
 &nbsp;  | Crystal | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | **🔴 37.1µs** | 11.6µs / None | 12.9µs / None | 5.28µs
Day 02 | - | 459µs / 189 KB | 52µs / 16.0 KB | 4.29µs
Day 03 | - | 556µs / 190 KB | 467µs / 279 KB | 457µs
Day 04 | - | 948ms / 56.0 B | **🔴 1.5s** / 159 MB | **🔴 1s**
...
*Total* | *37.1µs* | *5.51s / 1.1 GB* | *4.14s / 994 MB* | *1.01s*
...
## Crystal
 &nbsp;  | 2015 | 2019 | 2020 | 2021
 ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | **🔴 37.1µs** | 9.07µs | 240µs | **🔴 207µs**
...
Day 24 | - | 33.8ms | **🔴 6.1s** | -
Day 25 | - | 1.44s | 38.9ms | -
*Total* | *37.1µs* | *12s* | *7.86s* | *368µs*


## Golang
 &nbsp;  | 2015 | 2016 | 2017 | 2018 | 2019 | 2020 | 2021 | 2022 | 2023 | 2024
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 11.6µs / None | 168µs / 101 KB | 10.7µs / 2.3 KB | 645µs / None | 5.45µs / 3.4 KB | 18.1ms / 14.1 MB | 59.8µs / 81.9 KB | 8.96µs / None | 198µs / None | 47.2µs / None
...
Day 03 | 556µs / 190 KB | 62.3µs / 49.2 KB | 30.9µs / 15.9 KB | 88.5ms / 64.2 MB | 7.07ms / 10.0 MB | 22.5µs / 16.3 KB | 23.9µs / None | 23.7µs / None | 30.3µs / None | 29.1µs / None
...
Day 06 | 64.9ms / 252 KB | 114µs / 4.6 KB | 16.1ms / 6.6 MB | 30.1ms / 19.4 KB | 31.8ms / 18.4 MB | 3.62ms / 4.0 MB | 999ns / None | 4.73µs / None | 135ns / None | 4.94ms / None
...
Day 08 | 21.2µs / 11.4 KB | 3.71µs / 96.0 B | 617µs / 318 KB | 249µs / 162 KB | 170µs / 29.7 KB | 4.41ms / 5.5 MB | 260µs / 167 KB | 388µs / None | 939µs / 426 KB | 6.79µs / None
...
Day 11 | 26.8ms / 313 KB | 24.7ms / 16.8 MB | 139µs / 11.1 KB | 27.8ms / 721 KB | 2.95ms / 888 KB | 45ms / 4.6 MB | 466µs / 223 KB | 3.69ms / None | 13.2µs / None | 1.35ms / None
...
Day 14 | 239µs / 108 KB | **🔴 9.17s** / 33.1 KB | 24.9ms / 1.7 MB | 118ms / 21.0 MB | 6.08ms / 281 KB | 10.6ms / 7.4 MB | 270µs / 119 KB | 3.11ms / None | 16.3ms / 16.4 KB | 268µs / 32.0 B
...
Day 16 | 511µs / 262 KB | 114ms / 17.8 MB | 191ms / 82.8 MB | 16.4ms / 10.1 MB | 179ms / 1.1 MB | 1.8ms / 1.1 MB | 9.8µs / 5.1 KB | **🔴 141ms** / **🔴 134 MB** | 21.8ms / 98.3 KB | 565µs / None
Day 17 | 64.5ms / 3.0 KB | 91.3ms / 52.5 MB | 240ms / 48.5 KB | 45.8ms / 12.1 MB | 1.11ms / 303 KB | **🔴 540ms** / **🔴 338 MB** | 1.29ms / 64.0 B | 468µs / 229 KB | **🔴 223ms** / **🔴 13.2 MB** | 19.4µs / 24.0 B
...
*Total* | *5.51s / 1.1 GB* | *13.9s / 314 MB* | *1.72s / 430 MB* | *4.62s / 1.1 GB* | *1.25s / 880 MB* | *2.01s / 760 MB* | *946ms / 234 MB* | *441ms / 209 MB* | *874ms / 40.1 MB* | *55.4ms / 14.5 KB*
...
## Zig
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 5.28µs | 353µs | 5.18µs | 79.9µs | 37.7µs
Day 02 | 4.29µs | 57.3µs | 720ns | 2.39µs | 23.9µs
Day 03 | 457µs | 11.8µs | 50.3µs | 18.7µs | 28.2µs
Day 04 | **🔴 1s** | 1.74ms | 53µs | 51.6µs | 142µs
Day 05 | - | 188µs | 644µs | 1.97ms | 13.7µs
Day 06 | - | 7.73ms | 873ns | 89ns | 4.42ms
Day 07 | - | 511µs | 26.4µs | 108µs | 207µs
Day 08 | - | 4.66ms | 1.04ms | 222µs | 4.4µs
Day 09 | - | 163µs | 118µs | 19.5µs | 316µs
Day 10 | - | 28.7µs | 26.1µs | 88.4µs | 1.22ms
Day 11 | - | 17.2ms | 70.4µs | 10.8µs | 987µs
Day 12 | - | 1.57ms | 148µs | **🔴 16.8ms** | 13.5ms
Day 13 | - | 9.22µs | 259µs | 93.2µs | 4.54µs
Day 14 | - | - | 64.6µs | - | 4.6ms
Day 15 | - | 542ms | **🔴 10.6ms** | 62.9µs | 1.17ms
Day 16 | - | 1.23ms | 310µs | **🔴 43.1ms** | 8.59ms
Day 17 | - | 5.02ms | 1.45ms | - | 75.4µs
...
Day 25 | - | 34.1ms | - | - | 157µs
*Total* | *1.01s* | *5.43s* | *21.2ms* | *66.2ms* | *94ms*
