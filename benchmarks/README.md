...
Day 24 | - | - | -
Day 25 | - | - | -
*Total* | *197µs / None* | *92.8µs / None* | *74.1µs*
...
Day 09 | - | 560µs / 238 KB | - | 104µs / 19.6 KB | 118µs
Day 10 | - | 13.4µs / 920 B | - | 14.5µs / 2.5 KB | 26.1µs
Day 11 | - | 457µs / 223 KB | - | 79.8µs / 319 B | 70.4µs
...
Day 18 | - | 28.2ms / 4.8 MB | - | 22.9ms / 15.5 MB | **🔴 6.08ms**
...
Day 04 | 743µs | 476µs / 237 KB | 49.1µs / None | 2.4ms
Day 05 | 488µs | 100µs / 51.9 KB | 64.5µs / 12.4 KB | 188µs
Day 06 | 1.88ms | 2.89ms / 2.2 MB | 15µs / None | 7.73ms
Day 07 | 690µs | 1.49ms / 648 KB | 255µs / 281 KB | 511µs
...
*Total* | *7.86s* | *2.01s / 758 MB* | *855ms / 108 MB* | *5.43s*
...
Day 02 | 600µs | 2.97ms | 6.12ms / 9.3 MB | 2.04ms / None
...
Day 12 | 157ms | 122ms | 9.14ms / 736 B | 4.03ms / None
Day 13 | 76.6ms | 98.8ms | 9.98ms / 2.9 MB | 5.1µs / None
...
Day 17 | 11.8ms | 14.1ms | 1.22ms / 304 KB | 4.75µs / None
Day 18 | - | **🔴 9.25s** | **🔴 489ms** / **🔴 405 MB** | **🔴 175ms** / **🔴 94.4 MB**
...
Day 24 | 21.2ms | 33.8ms | **🔴 266ms** / **🔴 196 MB** | 5.06ms / None
Day 25 | **🔴 825ms** | 1.44s | 75.3ms / 43.4 MB | 10.5µs / None
*Total* | *2.02s* | *12s* | *1.28s / 873 MB* | *329ms / 95.6 MB*
...
Day 15 | 524ms / **🔴 251 MB** | **🔴 156ms** / 377 KB
...
Day 20 | 27.5ms / 8.6 MB | 293µs / None
...
*Total* | *4.71s / 1.0 GB* | *527ms / 97.9 MB*
...
Day 04 | 1.93ms / 825 KB | 3.11ms / 2.0 MB
...
Day 18 | 7.81ms / 5.7 MB | 9.99µs / None
Day 19 | 215µs / 44.8 KB | 35.5µs / None
Day 20 | 335ms / **🔴 206 MB** | 17.3ms / None
Day 21 | 65.3ms / 37.7 MB | 3.39µs / None
...
*Total* | *14.3s / 314 MB* | *12.9s / 1.7 GB*
...
Day 04 | - | 966ms / 56.0 B | **🔴 1.34s** / 159 MB
...
Day 12 | - | 72.4ms / 392 MB | 299µs / 357 KB
...
## Golang
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 11.7µs / None | 168µs / 101 KB | 10.7µs / 2.3 KB | 645µs / None | 5.45µs / 3.4 KB | 18.1ms / 14.1 MB | 59.8µs / 81.9 KB | 8.96µs / None | **🔴 190µs** / None
Day 02 | 459µs / 189 KB | 7.97µs / 192 B | 17.1µs / 8.3 KB | 5.04ms / 2.8 MB | 6.12ms / 9.3 MB | 511µs / 280 KB | 855ns / None | 1.89µs / None | 7.13µs / None
...
*Total* | *7.07s / 2.2 GB* | *14.3s / 314 MB* | *1.72s / 430 MB* | *4.71s / 1.0 GB* | *1.28s / 873 MB* | *2.01s / 758 MB* | *946ms / 234 MB* | *441ms / 209 MB* | *197µs / None*
...
Day 02 | 54.2µs / 16.0 KB | 77.1µs / 3.8 KB | 8.33µs / 2.0 KB | 489µs / None | 2.04ms / None | 23.6µs / 24.6 KB | 899ns / None | 642ns / None | -
Day 03 | 537µs / 279 KB | 252µs / 183 KB | 11.3µs / 14.3 KB | 4.16ms / None | 34.4µs / None | 2.69µs / None | 19.3µs / 2.0 KB | 19.2µs / None | -
Day 04 | **🔴 1.34s** / 159 MB | 1.62ms / 634 KB | 3.11ms / 2.0 MB | 11µs / None | 520µs / None | 49.1µs / None | 54.3µs / 102 KB | 5.64µs / None | -
...
*Total* | *4s / 994 MB* | *12.9s / 1.7 GB* | *1.46s / 55.5 MB* | *527ms / 97.9 MB* | *329ms / 95.6 MB* | *855ms / 108 MB* | *910ms / 320 MB* | *407ms / 98.6 MB* | *92.8µs / None*
