...
*Total* | *2.02s* | *12s* | *1.24s / 880 MB* | *286ms / 95.6 MB* | *1.36ms*
...
## 2015
 &nbsp;  | Crystal | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | **🔴 37µs** | 13.7µs / None | 12.9µs / None | 5.66µs
...
*Total* | *5.62s* | *2.55s* | *931ms* | *1.82s* | *1.36ms* | *5.43s* | *21.2ms* | *66.2ms* | *93.7ms*
