...
Day 14 | 17.7ms / 16.4 KB | 16.9ms / 0.2 B | 13.8ms / **🔴 3.4 KB**
Day 15 | 141µs / 58.1 KB | 62.2µs / None | 65.9µs / None
Day 16 | 21.8ms / 98.3 KB | 18.6ms / None | 51.5ms / None
Day 17 | **🔴 223ms** / **🔴 13.2 MB** | **🔴 284ms** / **🔴 9.3 MB** | 2.32ms / None
Day 18 | 6.73µs / None | 2.98µs / None | 4.52µs / None
Day 19 | 288µs / 245 KB | 143µs / None | 1.27ms / None
Day 20 | 1.44ms / 2.9 KB | 2.91ms / None | 2.81µs / None
Day 21 | 28.9ms / 62.0 KB | 13.1ms / None | 600µs / None
Day 22 | 5.13ms / 1.1 MB | 1.26ms / 14.5 KB | 1.12ms / None
Day 23 | **🔴 516ms** / 2.7 MB | **🔴 291ms** / None | **🔴 233ms** / None
Day 24 | - | - | 442µs / None
Day 25 | 47.1ms / **🔴 21.2 MB** | 7ms / None | 177µs / None
*Total* | *876ms / 40.1 MB* | *654ms / 9.3 MB* | *325ms / 3.4 KB*
...
Day 21 | - | 2.58ms / 2.3 MB | - | 1.11µs / 8.0 B | 1.06µs / None
Day 22 | - | 7.48ms / 3.8 MB | - | 11.4ms / 2.3 MB | 21.4ms / None
Day 23 | - | **🔴 252ms** / **🔴 155 MB** | - | **🔴 689ms** / **🔴 165 MB** | **🔴 279ms** / **🔴 107 MB**
Day 24 | - | 1.73µs / 656 B | - | 9.38µs / 576 B | 546ns / None
Day 25 | - | 32.9ms / None | - | 28.3ms / 19.4 KB | 295µs / None
*Total* | *368µs* | *902ms / 189 MB* | *2.97ms* | *844ms / 321 MB* | *334ms / 107 MB*
...
Day 14 | **🔴 8.95s** / 33.1 KB | **🔴 5.21s** / 76.0 B | **🔴 4.57s** / **🔴 65.0 B**
...
*Total* | *13.7s / 314 MB* | *13.4s / 1.7 GB* | *7.19s / 98.0 B*
...
Day 14 | 405µs / 425 B | **🔴 5.21s** / 76.0 B | 22.3ms / **🔴 39.2 MB** | **🔴 102ms** / **🔴 33.6 MB** | 2.14ms / 409 KB | 3.34ms / 4.5 MB | 15.6µs / 1.8 KB | 3.53ms / None | 16.9ms / 0.2 B | 3.8ms / None
...
Day 20 | **🔴 1.25s** / 126 MB | 84.1µs / 76.4 KB | 15ms / None | 207µs / None | 5.42ms / None | 128µs / 90.9 KB | 20.2ms / 2.0 MB | 24.4ms / None | 2.91ms / None | **🔴 25.8ms** / None
...
Day 22 | 204ms / **🔴 234 MB** | 10.6ms / 194 KB | 57.1ms / None | 13.9ms / None | 2.92µs / None | 35.2ms / 15.1 MB | 11.4ms / 2.3 MB | 305µs / None | 1.26ms / 14.5 KB | **🔴 48.1ms** / None
...
*Total* | *3.93s / 994 MB* | *13.4s / 1.7 GB* | *1.27s / 55.5 MB* | *510ms / 97.6 MB* | *267ms / 95.6 MB* | *801ms / 108 MB* | *844ms / 321 MB* | *341ms / 114 MB* | *654ms / 9.3 MB* | *94.7ms / None*
...
Day 14 | 41µs / None | **🔴 4.57s** / **🔴 65.0 B** | 31.5ms / None | 187ms / **🔴 20.5 MB** | 446µs / None | 6.23ms / 6.9 MB | 13.4µs / None | 2.59ms / None | 13.8ms / **🔴 3.4 KB** | 4.96ms / None
...
Day 17 | 2.24ms / None | 20.7ms / None | **🔴 215ms** / None | **🔴 1.44s** / 1.0 B | 4.17µs / None | **🔴 1m11.1s** / 937 KB | 1.52ms / None | 170µs / 102 KB | 2.32ms / None | 87.2µs / None
...
Day 19 | 2.68ms / 392 KB | 27ns / None | 20.1µs / None | 4.91µs / None | 7.71µs / None | 12.9ms / 108 KB | 14.9ms / 7.3 KB | 11.3ms / None | 1.27ms / None | 2.09ms / 20.6 KB
Day 20 | **🔴 3.33s** / 1.0 B | 25.8µs / None | 74.2ms / None | 196µs / None | 7.02ms / None | 10.7ms / 285 KB | 2.14ms / None | 37.8ms / None | 2.81µs / None | **🔴 22.4ms** / None
Day 21 | 4.02µs / None | 900ns / None | 4.3µs / None | 143µs / 328 KB | 5.67µs / None | 2.83ms / 152 KB | 1.06µs / None | 66.2µs / None | 600µs / None | 20µs / 4.3 KB
Day 22 | 8.27ms / None | 454µs / None | 55.8ms / None | 2.6ms / None | 2.14µs / None | 110ms / **🔴 2.6 GB** | 21.4ms / None | 803µs / None | 1.12ms / None | **🔴 35.4ms** / **🔴 1.1 MB**
Day 23 | 7.12µs / None | 59ns / None | 31.7µs / None | 32.2ms / None | 9.45µs / None | 5.48s / 48.0 MB | **🔴 279ms** / **🔴 107 MB** | 59.8ms / None | **🔴 233ms** / None | 506µs / None
Day 24 | **🔴 1.48s** / 1.0 B | 784µs / None | 70.3ms / None | 4.9ms / None | 3.1ms / 696 B | 81.5ms / 6.2 MB | 546ns / None | 82.6ms / **🔴 18.9 MB** | 442µs / None | 114µs / 40.3 KB
Day 25 | 96ns / None | 91ns / None | 36.8ms / None | 693µs / None | 13.4µs / None | 36.4ms / 160 B | 295µs / None | 1.12µs / None | 177µs / None | 167µs / None
*Total* | *5.93s / 14.5 MB* | *7.19s / 98.0 B* | *959ms / 73.4 KB* | *1.87s / 84.8 MB* | *879ms / 254 MB* | *1m17.5s / 2.9 GB* | *334ms / 107 MB* | *414ms / 71.4 MB* | *325ms / 3.4 KB* | *98.9ms / 1.2 MB*
