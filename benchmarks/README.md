...
Day 15 | 18.2ms / 14.6 KB | 4.62ms / 432 B | 247ns
...
## 2015
 &nbsp;  | Crystal | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | **🔴 35.5µs** | 13.7µs / None | 12.9µs / None | 5.31µs
Day 02 | - | 27.5µs / None | 52µs / 16.0 KB | 4.27µs
...
## Zig
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 5.31µs | 23.2µs | 352µs | 5.18µs | 75.3µs | 37.7µs
Day 02 | 4.27µs | 9.56µs | 57.6µs | 720ns | 2.39µs | 23.9µs
Day 03 | 457µs | 18.2µs | 12.1µs | 50.3µs | 18.4µs | 28.2µs
Day 04 | 1s | 416µs | 1.71ms | 53µs | 49.6µs | 142µs
...
Day 15 | 412µs | 247ns | 542ms | **🔴 10.6ms** | 62.9µs | 1.17ms
...
*Total* | *5.52s* | *2.53s* | *5.43s* | *21.2ms* | *66.2ms* | *93.7ms*
