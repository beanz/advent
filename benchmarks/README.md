...
## 2023
 &nbsp;  | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---: 
Day 01 | 198µs / None | 91.4µs / None | 78.7µs
...
*Total* | *37.6µs* | *5.5s / 1.1 GB* | *4.14s / 994 MB* | *1.05s*
...
## Zig
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 5.4µs | 353µs | 5.18µs | 78.7µs | 37.7µs
...
Day 25 | - | 34.1ms | - | - | 157µs
*Total* | *1.05s* | *5.43s* | *21.2ms* | *66.2ms* | *95.5ms*
