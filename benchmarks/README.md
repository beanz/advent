...
## 2025
 &nbsp;  | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---: 
Day 01 | **🔴 18.6µs** / None | **🔴 9.76µs** / None | **🔴 10.1µs** / None
Day 02 | - | - | -
Day 03 | - | - | -
Day 04 | - | - | -
Day 05 | - | - | -
...
Day 24 | - | - | -
Day 25 | - | - | -
*Total* | *18.6µs / None* | *9.76µs / None* | *10.1µs / None*
...
## Golang
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 13.7µs / None | 168µs / 101 KB | 10.7µs / 2.3 KB | 645µs / None | 5.45µs / 3.4 KB | 19.7ms / 14.1 MB | 59.8µs / 81.9 KB | 8.96µs / None | 198µs / None | 47.2µs / None | **🔴 18.6µs** / None
...
*Total* | *5.54s / 1.1 GB* | *13.7s / 314 MB* | *1.75s / 432 MB* | *2.98s / 1.0 GB* | *1.27s / 880 MB* | *2.01s / 760 MB* | *902ms / 189 MB* | *457ms / 209 MB* | *876ms / 40.1 MB* | *55.4ms / 14.5 KB* | *18.6µs / None*
