...
Day 10 | 23.7µs | 78.2µs | 28.4µs | 1.19µs | 52.1µs
Day 11 | 466ms | 79.3ms | 36.5ms | 25.6ms | 38.7ms
...
Day 16 | 5.05ms | 2.22ms | 1.57ms | 468µs | 1.97ms
...
*Total* | *17.2s* | *3.82s* | *2.9s* | *696ms* | *8.99s*
...
Day 02 | 769µs | 17.9µs | 31.6µs | 9.68ms | 2.57ms | 836µs | 1.4µs | **🔴 4.58µs**
...
*Total* | *11.4s* | *20.5s* | *3.49s* | *11s* | *2.37s* | *3.82s* | *1.68s* | *20.9µs*
...
## Rust
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 7.02µs | 79.2µs | 2.14µs | 248µs | 27.3µs | 33ns
Day 02 | 99.5µs | 141µs | 17µs | 68.4µs | 1.5µs | **🔴 8.23µs**
...
Day 10 | 779ms | 261µs | 213µs | 1.19µs | 81.4µs | -
Day 11 | 84ms | 1.86s | 171µs | 25.6ms | 240µs | -
...
Day 16 | 474µs | 168ms | 29.1ms | 468µs | 12.5µs | -
...
*Total* | *6.64s* | *1m10.5s* | *2.95s* | *696ms* | *1.77s* | *8.27µs*
