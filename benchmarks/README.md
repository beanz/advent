...
## 2023
 &nbsp;  | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---: 
Day 01 | 179µs / None | 92.8µs / None | 77.9µs
Day 02 | 6.13µs / None | 2.4µs / None | 2.72µs
Day 03 | 26.3µs / None | 17.4µs / None | 14.3µs
Day 04 | 33.8µs / 256 B | 18.9µs / None | 55.5µs
Day 05 | 54.3µs / 10.8 KB | 11.1µs / None | 2.02ms
Day 06 | 140ns / None | 97ns / None | 95ns
Day 07 | 371µs / 49.4 KB | 68.5µs / **🔴 24.5 KB** | 47.8µs
Day 08 | 976µs / 426 KB | **🔴 2.79ms** / None | 239µs
Day 09 | 38.2µs / None | 21.6µs / None | 21.1µs
Day 10 | 1.16ms / 891 KB | 85.7µs / None | 88.4µs
Day 11 | 268µs / None | 247µs / None | **🔴 19.7ms**
Day 12 | **🔴 390ms** / None | - | -
...
Day 24 | - | - | -
Day 25 | - | - | -
*Total* | *717ms / 94.9 MB* | *13.2ms / 24.5 KB* | *73.7ms*
...
## Golang
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 11.7µs / None | 168µs / 101 KB | 10.7µs / 2.3 KB | 645µs / None | 5.45µs / 3.4 KB | 18.1ms / 14.1 MB | 59.8µs / 81.9 KB | 8.96µs / None | 179µs / None
Day 02 | 459µs / 189 KB | 7.97µs / 192 B | 17.1µs / 8.3 KB | 5.04ms / 2.8 MB | 4.87ms / 9.3 MB | 511µs / 280 KB | 855ns / None | 1.89µs / None | 6.13µs / None
Day 03 | 552µs / 190 KB | 62.3µs / 49.2 KB | 30.9µs / 15.9 KB | 88.5ms / 64.2 MB | 7.07ms / 10.0 MB | 22.5µs / 16.3 KB | 23.9µs / None | 23.7µs / None | 26.3µs / None
Day 04 | 948ms / 56.0 B | 1.78ms / 642 KB | 1.57ms / 825 KB | 2.85ms / 399 KB | 1.15ms / 80.0 B | 429µs / 237 KB | 122µs / 79.2 KB | 8.87µs / None | 33.8µs / 256 B
Day 05 | 252µs / 34.8 KB | **🔴 3.8s** / 3.4 KB | 80.1ms / 25.5 MB | 256ms / 48.3 MB | 58.9µs / 78.8 KB | 100µs / 51.9 KB | 2.13ms / 1.1 MB | 4.76µs / None | 54.3µs / 10.8 KB
Day 06 | 64.9ms / 252 KB | 114µs / 4.6 KB | 16.1ms / 6.6 MB | 30.1ms / 19.4 KB | 31.8ms / 18.4 MB | 3.62ms / 4.0 MB | 999ns / None | 4.73µs / None | 140ns / None
...
Day 08 | 21.2µs / 11.4 KB | 3.71µs / 96.0 B | 617µs / 318 KB | 249µs / 162 KB | 170µs / 29.7 KB | 4.41ms / 5.5 MB | 260µs / 167 KB | 388µs / None | 976µs / 426 KB
...
Day 10 | 60.3ms / 56.6 MB | 8.12ms / 5.5 MB | 436µs / 11.4 KB | 1.24ms / 768 KB | 15.1ms / 11.3 MB | 93.1µs / 62.2 KB | 13.4µs / 920 B | 809ns / None | 1.16ms / 891 KB
...
Day 12 | 853µs / 367 KB | 4.74µs / 3.0 KB | 3.33ms / 1.2 MB | 1.91ms / 1.5 MB | 9.72ms / 736 B | 130µs / 78.6 KB | 1.79ms / 3.0 MB | 208µs / None | **🔴 390ms** / None
...
*Total* | *5.51s / 1.1 GB* | *13.9s / 314 MB* | *1.72s / 430 MB* | *4.62s / 1.1 GB* | *1.25s / 880 MB* | *2.01s / 760 MB* | *946ms / 234 MB* | *441ms / 209 MB* | *717ms / 94.9 MB*
...
*Total* | *4s / 994 MB* | *12.9s / 1.7 GB* | *1.46s / 55.5 MB* | *527ms / 97.9 MB* | *329ms / 95.6 MB* | *855ms / 108 MB* | *910ms / 320 MB* | *407ms / 98.6 MB* | *13.2ms / 24.5 KB*


## Zig
 &nbsp;  | 2020 | 2021 | 2023
 ---:  | ---:  | ---:  | ---: 
Day 01 | 359µs | 12.2µs | 77.9µs
Day 02 | 96.4µs | 720ns | 2.72µs
Day 03 | 17.1µs | 50.3µs | 14.3µs
Day 04 | 2.21ms | 53µs | 55.5µs
Day 05 | 188µs | 710µs | 2.02ms
Day 06 | 7.73ms | 873ns | 95ns
Day 07 | 511µs | 26.4µs | 47.8µs
Day 08 | 4.66ms | 1.04ms | 239µs
Day 09 | 163µs | 118µs | 21.1µs
Day 10 | 33µs | 26.1µs | 88.4µs
Day 11 | 17.2ms | 70.4µs | **🔴 19.7ms**
Day 12 | 1.57ms | 148µs | -
Day 13 | 9.22µs | 259µs | -
Day 14 | - | 64.6µs | -
