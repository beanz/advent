...
Day 07 | 1.62ms | 2.03ms | 2.46ms | 419µs | 1.32ms
...
Day 17 | 298ms | **🔴 849ms** | 113ms | 70.9ms | **🔴 2m32s**
Day 18 | 5.91ms | 20.8ms | 1.2ms | 250µs | 12.4ms
Day 19 | 7.69ms | 28.6ms | 212ms | - | 25ms
...
*Total* | *17.2s* | *3.82s* | *2.9s* | *793ms* | *2m41s*
...
Day 03 | 754µs | 73.7µs | 32µs | 198ms | 19.8ms | 43.8µs | 49.9µs | **🔴 49.9µs**
...
*Total* | *11.4s* | *20.5s* | *3.49s* | *11s* | *2.37s* | *3.82s* | *1.68s* | *70.9µs*
...
Day 03 | 910µs | 381µs | 21.1µs | 5.59µs | 41.6µs | **🔴 37.6µs**
...
*Total* | *6.79s* | *1m8.8s* | *2.98s* | *793ms* | *1.92s* | *39.1µs*
