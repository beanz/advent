...
Day 03 | 754µs | 73.7µs | 32µs | 198ms | 19.8ms | 43.8µs | 49.9µs | **🔴 62.2µs**
...
*Total* | *11.4s* | *20.5s* | *3.49s* | *11s* | *2.37s* | *3.82s* | *1.68s* | *83.2µs*
...
*Total* | *6.79s* | *1m8.8s* | *2.98s* | *793ms* | *1.92s* | *1.47µs*
