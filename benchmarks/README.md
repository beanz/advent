...
Day 02 | 600µs | 2.97ms | 4.87ms / 9.3 MB | 2.23ms / None | **🔴 561µs**
...
*Total* | *2.02s* | *12s* | *1.25s / 880 MB* | *286ms / 95.6 MB* | *562µs*
...
Day 02 | 4.48µs | 9.56µs | 3.8µs | 62.5µs | **🔴 561µs** | 57.6µs | 720ns | 2.39µs | 23.9µs
...
*Total* | *5.62s* | *2.55s* | *931ms* | *1.82s* | *562µs* | *5.43s* | *21.2ms* | *66.2ms* | *93.7ms*
