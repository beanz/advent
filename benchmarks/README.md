...
Day 09 | 462µs / None | 583µs / None | -
Day 10 | 114µs / None | 39µs / None | -
...
Day 17 | 19.5µs / 24.0 B | 216µs / None | -
...
Day 23 | **🔴 63.3ms** / **🔴 48.9 MB** | - | -
Day 24 | - | - | -
Day 25 | - | - | -
*Total* | *244ms / 52.2 MB* | *217ms / None* | *221ms*
...
## 2023
 &nbsp;  | Golang | Rust | Zig
 ---:  | ---:  | ---:  | ---: 
Day 01 | 198µs / None | 91.4µs / None | 76.3µs
Day 02 | 7.3µs / None | 2.45µs / None | 2.28µs
Day 03 | 30.3µs / None | 24.2µs / None | 17.9µs
Day 04 | 34.3µs / 256 B | 17.1µs / None | 51.5µs
Day 05 | 60.8µs / 10.8 KB | 12.7µs / None | 1.96ms
Day 06 | 135ns / None | 108ns / None | 90ns
Day 07 | 371µs / 49.4 KB | 70.4µs / 24.5 KB | 106µs
Day 08 | 939µs / 426 KB | 2.37ms / None | 300µs
Day 09 | 38.2µs / None | 23.1µs / None | 17.9µs
...
Day 23 | 22.4µs / 9.3 KB | 12.8µs / 9.0 KB | 1.54ms / 4.6 KB | 162ms / 1.7 MB | 7.34ms / 4.7 MB | **🔴 677ms** / 32.0 MB | **🔴 296ms** / **🔴 199 MB** | 60.9ms / 2.0 MB | **🔴 516ms** / 2.7 MB | **🔴 63.3ms** / **🔴 48.9 MB**
...
*Total* | *5.51s / 1.1 GB* | *13.9s / 314 MB* | *1.72s / 430 MB* | *4.62s / 1.1 GB* | *1.25s / 880 MB* | *2.01s / 760 MB* | *946ms / 234 MB* | *441ms / 209 MB* | *874ms / 40.1 MB* | *244ms / 52.2 MB*
...
Day 09 | 5.06ms / 651 KB | 142µs / 361 KB | 45.2µs / 89.3 KB | 41.3ms / **🔴 64.0 MB** | 1.78ms / None | 65.6µs / None | 99.2µs / 19.6 KB | 188µs / None | 23.1µs / None | 583µs / None
...
Day 22 | 416ms / **🔴 234 MB** | 10.6ms / 194 KB | 57.1ms / None | 13.9ms / None | 2.92µs / None | 35.2ms / 15.1 MB | 11.4ms / 2.3 MB | 317µs / None | 1.31ms / 7.5 KB | **🔴 103ms** / None
...
*Total* | *4.14s / 994 MB* | *13.9s / 1.7 GB* | *1.27s / 55.5 MB* | *514ms / 97.9 MB* | *286ms / 95.6 MB* | *801ms / 108 MB* | *846ms / 321 MB* | *386ms / 98.6 MB* | *654ms / 9.3 MB* | *217ms / None*


## Zig
 &nbsp;  | 2020 | 2021 | 2023 | 2024
 ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 341µs | 5.12µs | 76.3µs | 31.5µs
Day 02 | 57.3µs | 720ns | 2.28µs | 23.6µs
Day 03 | 11.8µs | 50.3µs | 17.9µs | 24.5µs
Day 04 | 2ms | 53µs | 51.5µs | 144µs
Day 05 | 188µs | 652µs | 1.96ms | 13µs
Day 06 | 7.73ms | 873ns | 90ns | **🔴 204ms**
Day 07 | 511µs | 26.4µs | 106µs | 16.8ms
Day 08 | 4.66ms | 1.04ms | 300µs | 5.93µs
Day 09 | 163µs | 118µs | 17.9µs | -
Day 10 | 29.1µs | 26.1µs | 84.6µs | -
Day 11 | 17.2ms | 70.4µs | 10.4µs | -
Day 12 | 1.57ms | 148µs | **🔴 17.1ms** | -
...
Day 24 | 77.3ms | - | - | -
Day 25 | 34.1ms | - | - | -
*Total* | *5.43s* | *21.2ms* | *72.1ms* | *221ms*
