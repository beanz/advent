...
## Golang
 ...
 ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---:  | ---: 
Day 01 | 29.1µs | 130µs | 39.5µs | 19.5ms | 6.72µs | 21.9ms | 29.1µs | **🔴 16.4µs**
...
*Total* | *11.4s* | *20.5s* | *3.49s* | *11s* | *2.37s* | *3.82s* | *1.68s* | *16.4µs*
...
*Total* | *6.64s* | *1m10.5s* | *2.95s* | *695ms* | *1.77s* | *33ns*
